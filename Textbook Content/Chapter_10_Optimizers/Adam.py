...
#---------------------------------------------------------------------------------------------------------------------------
"""
Adam (Adaptive Momentum) is currently the most widely-used optimizer and is built atop RMSProp, with the momentum concept 
from SGD added back in. The Adam optimizer additionally adds a bias correction mechanism.
"""
import numpy as np
